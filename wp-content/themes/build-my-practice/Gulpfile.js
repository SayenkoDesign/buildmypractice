...
// Settings
const proxy_url = 'https://buildmypractice.vanwp.ca'; // using SSL? Don't forget to set the Watch https keys
...
gulp.task('default', ['watch'], function () {
	...
	gulp.start('i18n', 'styles', 'bower', 'foundation-js', 'concat', 'scripts', 'imagemin');
