...
class CPT_Business_Cards extends CPT_Core {
    ...
    public function __construct() {
        ...
        add_filter( 'wp_insert_post_data' , array( $this, 'modify_post_title' ) , '99', 2 ); // Grabs the inserted post data so you can modify it.
	...
	public function columns_display( $column, $post_id ) {
        ...
        switch ( $column ) {
            ...
            $client = get_field( 'business_card_client' );
            if( is_object( $client ) ) {
                printf( '%s', $client->post_title );
            }
            break;
